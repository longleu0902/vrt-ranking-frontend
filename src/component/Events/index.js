...
export const Events = () => {
  ...
  const data = {
    ...
    description: `
      ...
      - Cập nhật thông tin trên Fanpage để biết chính xác thông tin Họp lãnh đội.
      ...
      ● Đơn vị tổ chức: Cục Thể dục Thể thao, Ủy ban Olympic Việt Namm
      ...
      <Row>
        ...
        >
          <div
            style={{
              ...
              borderRadius: 10,
              boxShadow: "0 2px 4px rgba(0, 0, 0, .1), 0 8px 16px rgba(0, 0, 0, 0.4)"
            }}
          >
            <div className="post-title">
              <Avatar src={logo} />
              <div>
                <a style={{ fontSize: 15, color: "#fff", fontWeight: 700 }}>
                  {data?.title}
                </a>
        ...
        >
          ...
          >
            ...
            <TimelineView textColor={"#fff"} data={achievements} />
          </div>
        </Col>
      </Row>
    </div>
